...
import { DEPLOYMENT_MIGRATION_CONTRACT } from "./deployment-migration-contract.mjs";
...
export function validateDeploymentConfiguration(environment = process.env) {
  ...
  const [serverUrl] = requireCompletePair(
    environment,
    "SUPABASE_URL",
    "SUPABASE_SECRET_KEY",
...
export function compareMigrationHistory(checkedInRows, appliedVersions) {
  ...
  const checkedIn = new Set(checkedInVersions);
